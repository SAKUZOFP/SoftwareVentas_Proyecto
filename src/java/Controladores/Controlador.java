...
//                  String categoriaUpdate = request.getParameter("txtcategoria");
//                  String estadoProductoUpdate = request.getParameter("txtestadoProducto");
...
//                  producto1.setCategoria(categoriaUpdate);
//                  producto1.setEstadoProducto(estadoProductoUpdate);
                    producto1.setCodigo(idProducto);
                    ProductoDAO.Actualiza(producto1);
                    request.getRequestDispatcher("Controlador?menu=Productos&accion=Listar").forward(request, response);
